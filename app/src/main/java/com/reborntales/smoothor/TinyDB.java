...
public class TinyDB {
    ...
    public Collection<? extends Route> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Route> objects = new ArrayList<>();

    	for(String jObjString : objStrings){
    		Route value  = gson.fromJson(jObjString, Route.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Route> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Route obj : objArray){
